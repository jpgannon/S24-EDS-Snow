...
#hopefully should fix raster dplyr problems
regioncoords <- region %>% dplyr::select(lat, long)
snowchangeNov15to30 <- raster::raster("Data/Rasters/SnowChange_11_15_11_30.tif")
raster_values <- raster::extract(snowchangeNov15to30, regioncoords)
